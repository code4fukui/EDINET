...
Deno.test("simple", () => {
  ...
  t.assertEquals(fixBigNum(100000), "10.00万");
  t.assertEquals(fixBigNum(1000000), "100.0万");
  t.assertEquals(fixBigNum(10000000), "0.10億");
  t.assertEquals(fixBigNum(100000000), "1.00億");
  t.assertEquals(fixBigNum(1000000000), "10.00億");
  t.assertEquals(fixBigNum(10000000000), "100.0億");
...
Deno.test("mega", () => {
  ...
  t.assertEquals(fixBigNum(1000, true), "10.00億");
  t.assertEquals(fixBigNum(10000, true), "100.0億");
  t.assertEquals(fixBigNum(100000, true), "0.10兆");
  t.assertEquals(fixBigNum(1000000, true), "1.00兆");
  t.assertEquals(fixBigNum(10000000, true), "10.00兆");
  t.assertEquals(fixBigNum(100000000, true), "100.0兆");
  t.assertEquals(fixBigNum(1000000000, true), "0.10京");
  t.assertEquals(fixBigNum(10000000000, true), "1.00京");
  t.assertEquals(fixBigNum(100000000000, true), "10.00京");
  t.assertEquals(fixBigNum(1000000000000, true), "100.0京");
